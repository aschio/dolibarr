...
/**
 * 	\defgroup	ciai	Ciai module
 * 	\brief		Ciai module descriptor.
 * 	\file		core/modules/modCiai.class.php
 * 	\ingroup	ciai
 * 	\brief		Description and activation file for module Ciai
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module Ciai
 */
class modCiai extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "Description of module Ciai";
		...
		$this->picto = 'ciai@ciai'; // mypicto@ciai
		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /ciai/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /ciai/core/modules/barcode)
		// for specific css file (eg: /ciai/css/ciai.css.php)
		...
		// Example: this->dirs = array("/ciai/temp");
		$this->dirs = array();

		// Config pages. Put here list of php pages
		// stored into ciai/admin directory, used to setup module.
		$this->config_page_url = array("admin_ciai.php@ciai");
		...
		// Language files list (langfiles@ciai)
		$this->langfiles = array("ciai@ciai");
		// Constants
		...
		$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@ciai:$user->rights->ciai->read:/ciai/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@ciai:$user->rights->othermodule->read:/ciai/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->ciai->enabled)) {
			$conf->ciai=new stdClass();
			$conf->ciai->enabled = 0;
		}
		$this->dictionaries = array();
		/* Example:
		  // This is to avoid warnings
		  if (! isset($conf->ciai->enabled)) $conf->ciai->enabled=0;
		  $this->dictionaries=array(
			  'langs'=>'ciai@ciai',
		...
		//	'leftmenu'=>'ciai',
		//	'url'=>'/ciai/pagetop.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->ciai->enabled' if entry must be visible if module is enabled.
		//	'enabled'=>'$conf->ciai->enabled',
		//	// Use 'perms'=>'$user->rights->ciai->level1->level2'
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'Ciai left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'ciai',
		// This menu's leftmenu ID
		//	'leftmenu'=>'ciai',
		//	'url'=>'/ciai/pagelevel1.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /ciai/sql/
	...
	{
		return $this->_load_tables('/ciai/sql/');
	}
}
